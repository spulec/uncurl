import sure  # Hey! Don't remove this import for the tests to pass
...
def test_basic_headers():
    uncurl.parse(("curl 'https://pypi.python.org/pypi/uncurl' -H 'Accept-Encoding: gzip,deflate,sdch' "
                  "-H 'Accept-Language: en-US,en;q=0.8'")).should.equal(
        """requests.get("https://pypi.python.org/pypi/uncurl",
    headers={
...
def test_cookies():
    uncurl.parse(("curl 'https://pypi.python.org/pypi/uncurl' -H 'Accept-Encoding: gzip,deflate,sdch' "
                  "-H 'Cookie: foo=bar; baz=baz2'")).should.equal(
        """requests.get("https://pypi.python.org/pypi/uncurl",
    headers={
        "Accept-Encoding": "gzip,deflate,sdch"
    },
...
def test_post():
    ...
    "now":1396219192277,"ab":{"welcome_email":{"v":"2","g":2}}}]' -H 'Accept-Encoding: gzip,deflate,sdch' 
    -H 'Cookie: foo=bar; baz=baz2'""")).should.equal(
...
def test_post_with_dict_data():
    uncurl.parse(("""curl 'https://pypi.python.org/pypi/uncurl' 
    --data '{"evt":"newsletter.show","properties":{"newsletter_type":"userprofile"}}' 
    -H 'Accept-Encoding: gzip,deflate,sdch' -H 'Cookie: foo=bar; baz=baz2'""")).should.equal(
        """requests.post("https://pypi.python.org/pypi/uncurl",
    data={
        "evt": "newsletter.show",
        "properties": {
